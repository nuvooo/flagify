...
export default function Dashboard() {
  ...
  const { organizations, stats, fetchOrganizations, isLoading } =
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {stats?.totalOrganizations ?? organizations.length ?? 0}
            </div>
            <p className="text-xs text-muted-foreground">
              {t('dashboard.stats.organizations-description')}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              {t('dashboard.stats.feature-flags')}
            </CardTitle>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-2 mt-1">
              <Badge variant="secondary" className="text-xs">
                {t('dashboard.stats.feature-flags-enabled', {
                  count: stats?.totalEnabledFlags ?? 0,
                })}
              </Badge>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {t('dashboard.stats.activity-description')}
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          <Card className="border-dashed">
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="text-lg font-semibold mb-2">
                {t('dashboard.organizations.no-organizations')}
              </h3>
                  ...
                  <CardContent>
                    <div className="flex items-center gap-4 text-sm text-muted-foreground">
                      <div className="flex items-center gap-1">
                        ...
                        <span>
                          {t('dashboard.organizations.projects-count', {
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span>
                          {t('dashboard.organizations.members-count', {
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-semibold tracking-tight">
          {t('dashboard.quick-actions.title')}
        </h2>
        <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold">
                    {t('dashboard.quick-actions.new-organization')}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {t('dashboard.quick-actions.new-organization-desc')}
                  </p>
                </div>
              </div>
            </Link>
          ...
          {organizations.length > 0 && (
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              <Link
                to={`/organizations/${organizations[0].id}?action=create-project`}
                className="block p-6"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold">
                      {t('dashboard.quick-actions.new-project')}
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      {t('dashboard.quick-actions.new-project-desc', {
          ...
          {organizations.length > 0 && (
            <Card className="hover:shadow-md transition-shadow cursor-pointer">
              <Link
                to={`/organizations/${organizations[0].id}`}
                className="block p-6"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold">
                      {t('dashboard.quick-actions.feature-flags')}
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      {t('dashboard.quick-actions.feature-flags-desc')}
                    </p>
                  </div>
                </div>
              </Link>
