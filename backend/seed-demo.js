...
async function seed() {
  ...
  if (!user) {
    user = await prisma.user.create({
      data: {
        ...
        password:
          '$2a$10$KfoUUR3eup3m/ohIuuLInu37h9rJBLcZO2zdfmcJyY5HRh5DPhAAW',
        firstName: 'Demo',
        lastName: 'User',
      },
    })
  ...
  console.log('\nTest URLs:')
  console.log(
    'All flags for brand-a: http://localhost:4000/sdk/flags/demo/development?tenantId=brand-a'
  )
  console.log(
    'All flags for brand-b: http://localhost:4000/sdk/flags/demo/development?tenantId=brand-b'
  )
  console.log(
    'Single flag: http://localhost:4000/sdk/flags/demo/development/new-feature?tenantId=brand-a'
  )
